...
- **[GRAPH.md](GRAPH.md)** — The serious version. 22 entities, 18 edges, 4 clusters. Structured for machines.
...
- **`scripts/`** — 7 reproducible probe scripts. Run them yourself. Everything is containerized.
